...
; wBluesHouseSceneID
	const_def 1
	const SCENE_BLUESHOUSE_NOTHING
	const SCENE_BLUESHOUSE_SPAWN
	
;wOaksLabSceneID
	const_def
	const SCENE_OAKSLAB_NOTHING
	const SCENE_OAKSLAB_CANT_LEAVE
	const SCENE_OAKSLAB_RIVAL_BATTLE_1
	const SCENE_OAKSLAB_GET_POKEDEX
